...
public class TransactionsDataSource {
	...
	public void insertTransaction(Transaction transaction) {
		insertLastFrequentedPlace(transaction.getPlace().toString());
	...
	public void deleteTransaction(Transaction transaction) {
		...
		dataBase.delete(MySQLiteHelper.TABLE_TRANSACTIONS,
				MySQLiteHelper.COLUMN_ID + " = " + tranId, null);
	...
	private void insertLastFrequentedPlace(String place) {
		...
		long in_id = dataBase.insert(MySQLiteHelper.TABLE_FREQUENT_PLACES,
				null, values);
		if (in_id == -1) {
			dataBase.execSQL("UPDATE " + MySQLiteHelper.TABLE_FREQUENT_PLACES
					+ " SET " + MySQLiteHelper.COLUMN_FREQEUNCY + "="
